...
const checkSlotAvailability = async (hospitalId, reservationTime) => {
  ...
  // 선택된 날짜에 대한 각 시간 슬롯의 예약 가능 여부 확인
  ...
  const handleReservation = async () => {
    ...
    const offset = reservationDateTime.getTimezoneOffset() * 60000; // 로컬 타임존 오프셋 계산
