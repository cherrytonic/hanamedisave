...
function ChatWindow(setChattingHospitalId, chattingHospitalId) {
  ...
  function handleGoBack() {
    console.log(chattingHospitalId);
    
    setChattingHospitalId(null)
  }
  const closeModal = () => {
    setIsOpen(false);
  };
  ...
  const ws = new SockJS('https://localhost:8080/api/chat');
  ...
  return (
    <div className="bg-white text-[#364C63] w-full h-full">
      <div
