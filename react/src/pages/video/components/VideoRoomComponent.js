...
class VideoRoomComponent extends Component {
    constructor(props) {
        ...
        let userName = this.props.memberNm ? this.props.memberNm : 'OpenVidu_User' + Math.floor(Math.random() * 100);
        let hospitalName = this.props.hospital ? this.props.hospital : 'Unknown Hospital';
        this.remotes = [];
    ...
    async createSession(sessionId) {
        ...
        const response = await medisave.post('/api/please/sessions', { customSessionId: sessionId }, {
    ...
    async createToken(sessionId) {
        ...
        const response = await medisave.post('/api/please/sessions/' + sessionId + '/connections', {}, {
            headers: { 'Content-Type': 'application/json', },
        });
        return response.data; // The token
    }
}
export default function VideoRoomWithNavigate(props) {
    const navigate = useNavigate();
    return <VideoRoomComponent {...props} navigate={navigate} />;
}
