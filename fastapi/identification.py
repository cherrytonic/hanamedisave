...
def detect_text(path, inputname, inputResident1, inputResident2):
    ...
    try:
        ...
        image_context = vision.ImageContext(language_hints=["ko", "zh"])
        ...
        resident_number = parcingdata[2]
        print("Detected Resident Number: ", resident_number)

        # 주민등록번호 앞자리와 뒷자리 추출
        resident1 = resident_number[:6]
        resident2 = resident_number[7:14]
        inputResident1 = str(inputResident1)
        inputResident2 = str(inputResident2)
        # 입력값과 비교
        if doc_type == '주민등록증' and name == inputname and resident1 == inputResident1 and resident2 == inputResident2:
            personalId = {
                "name": name,
                "resident1": resident1,
                "resident2": resident2
